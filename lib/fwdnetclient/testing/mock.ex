defmodule FwdClient.Testing.Mock do
  @moduledoc """
  ...
  Return values are tagged tuples with optional additional information. For example:
      ...
      {:ok, %FwdClient.Repository{}}
      {:ok, %FwdClient.Repository{}, code: 200}
      {:error, %FwdClient.Error{}}
      {:error, %FwdClient.Error{}, code: 404}

  For more on the possible values, see `FwdClient.Testing`.
  """
  @type return ::
          {:ok, any}
          | {:ok, any, keyword}
