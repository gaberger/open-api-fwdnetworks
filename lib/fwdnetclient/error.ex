defmodule FwdClient.Error do
  ...
  errors returned from the FwdClient API (for example, Not Found errors).
  ...
  meanings:
    ...
    * `:not_found`: A resource or route was not found. Note that FwdClient may return this kind of
  ...
  @typedoc "FwdClient API client error"
  @type t :: %__MODULE__{
          code: integer | nil,
          message: String.t(),
