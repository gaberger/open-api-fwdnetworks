defmodule FwdClient.Operation do
  @moduledoc """
  ...
  > are useful for plugins. See `FwdClient.Plugin` for more information.
  ...
  @typedoc "Type annotation produced by [OpenAPI](https://FwdClient.com/aj-foster/open-api-generator)"
  @type type ::
          :binary
          | :boolean
          | :integer
  ...
  ## Examples
      ...
      iex> operation = %Operation{private: %{__opts__: [server: "https://fwd.app"]}}
      iex> Operation.get_options(operation)
      [server: "https://fwd.app"]
  ...
  defp put_version_header(operation, version) do
    put_request_header(operation, "X-FwdClient-Api-Version", version)
  end
  ...
  defp put_user_agent(operation) do
    user_agent =
      IO.iodata_to_binary([
        ...
        " via oapi_fwdnetclient ",
        Application.spec(:oapi_fwdnetclient, :vsn),
        "; Elixir ",
        System.version(),
        " / OTP ",
        System.otp_release()
