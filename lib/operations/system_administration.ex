defmodule FwdClient.SystemAdministration do
  ...
  **Deprecated.** This operation will be removed in release 23.10.
  ...
  """
  @spec export_database_using_get(keyword) :: :ok | {:error, FwdClient.Error.t()}
  ...
  """
  @spec get_cve_index_using_get(keyword) :: {:ok, String.t()} | {:error, FwdClient.Error.t()}
  ...
  **Deprecated.** This operation will be removed in release 23.10.
  ...
  Use [Cluster Backup/Restore](/docs/enterprise/administration/on-prem/backup-restore) instead.
  """
  @spec import_database_using_put(keyword) :: :ok | {:error, FwdClient.Error.t()}
  ...
  **Note:** This operation is for on-premises deployments only.
  ...
  """
  @spec put_cve_index_using_put(String.t(), keyword) :: :ok | {:error, FwdClient.Error.t()}
