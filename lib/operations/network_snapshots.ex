defmodule FwdClient.NetworkSnapshots do
  ...
  @spec create_snapshot_using_post(String.t(), FwdClient.NetworkIdSnapshotsBody.t(), keyword) ::
          {:ok, FwdClient.SnapshotInfo.t()} | {:error, FwdClient.Error.t()}
  ...
  @spec get_snapshot_metrics_using_get(String.t(), keyword) ::
          {:ok, FwdClient.SnapshotMetrics.t()} | {:error, FwdClient.Error.t()}
  ...
  """
  @spec list_network_snapshots_using_get(String.t(), keyword) ::
  ...
  """
  @spec zip_snapshot_using_get(String.t(), keyword) :: :ok | {:error, FwdClient.Error.t()}
