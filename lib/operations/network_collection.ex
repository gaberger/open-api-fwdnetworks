defmodule FwdClient.NetworkCollection do
  ...
  @spec add_collection_schedule_using_post(
          ...
          keyword
        ) :: {:ok, FwdClient.CollectionSchedule.t()} | {:error, FwdClient.Error.t()}
  ...
  """
  @spec collect_using_post(String.t(), keyword) ::
          {:ok, FwdClient.EmptyObject.t()} | {:error, FwdClient.Error.t()}
  ...
  """
  @spec delete_collection_schedule_using_delete(String.t(), String.t(), keyword) ::
  ...
  @spec get_collection_schedules_using_get(String.t(), keyword) ::
          {:ok, FwdClient.CollectionSchedules.t()} | {:error, FwdClient.Error.t()}
  ...
  @spec get_collector_state_using_get(String.t(), keyword) ::
          {:ok, FwdClient.CollectorState.t()} | {:error, FwdClient.Error.t()}
