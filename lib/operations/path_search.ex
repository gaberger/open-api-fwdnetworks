defmodule FwdClient.PathSearch do
  ...
  """
  @spec get_l7_applications_using_get(keyword) ::
          {:ok, [FwdClient.L7Application.t()]} | {:error, FwdClient.Error.t()}
  ...
  @spec get_paths_bulk_by_snapshot_using_post(
          ...
          keyword
        ) :: {:ok, [FwdClient.PathSearchResponse.t()]} | {:error, FwdClient.Error.t()}
