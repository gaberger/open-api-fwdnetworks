defmodule FwdClient.Networks do
  ...
  """
  @spec create_network_using_post(keyword) ::
          {:ok, FwdClient.Network.t()} | {:error, FwdClient.Error.t()}
  ...
  Deletes a network
  """
  @spec delete_network_using_delete(String.t(), keyword) ::
          {:ok, FwdClient.Network.t()} | {:error, FwdClient.Error.t()}
  ...
  Lists all networks
  """
  @spec get_networks_using_get(keyword) ::
          {:ok, [FwdClient.Network.t()]} | {:error, FwdClient.Error.t()}
