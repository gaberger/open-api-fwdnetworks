defmodule FwdClient.SyntheticDevices do
  ...
  """
  @spec delete_encryptor_using_delete(String.t(), String.t(), keyword) :: :ok | :error
  ...
  @spec delete_internet_node_connections_using_delete(String.t(), keyword) ::
          {:ok, FwdClient.SyntheticConnections.t()} | :error
  ...
  """
  @spec delete_intranet_node_using_delete(String.t(), String.t(), keyword) :: :ok | :error
  ...
  Removes an L2VPN
  """
  @spec delete_l2_vpn_using_delete(String.t(), String.t(), keyword) :: :ok | :error
  ...
  Removes an L3VPN
  """
  @spec delete_l3_vpn_using_delete(String.t(), String.t(), keyword) :: :ok | :error
  ...
  """
  @spec delete_wan_circuit_using_delete(String.t(), String.t(), keyword) :: :ok | :error
  ...
  @spec get_encryptor_using_get(String.t(), String.t(), keyword) ::
          {:ok, FwdClient.Encryptor.t()} | :error
  ...
  @spec get_encryptors_using_get(String.t(), keyword) ::
          {:ok, FwdClient.EncryptorList.t()} | :error
  ...
  @spec get_internet_node_using_get(String.t(), keyword) ::
          {:ok, FwdClient.InternetNode.t()} | :error
  ...
  @spec get_intranet_node_using_get(String.t(), String.t(), keyword) ::
          {:ok, FwdClient.IntranetNode.t()} | :error
  ...
  @spec get_intranet_nodes_using_get(String.t(), keyword) ::
          {:ok, FwdClient.IntranetNodeList.t()} | :error
  ...
  """
  @spec get_l2_vpns_using_get(String.t(), keyword) :: {:ok, FwdClient.L2VpnList.t()} | :error
  ...
  """
  @spec get_l3_vpns_using_get(String.t(), keyword) :: {:ok, FwdClient.L3VpnList.t()} | :error
  ...
  @spec get_wan_circuit_using_get(String.t(), String.t(), keyword) ::
          {:ok, FwdClient.WanCircuit.t()} | :error
  ...
  @spec get_wan_circuits_using_get(String.t(), keyword) ::
          {:ok, FwdClient.WanCircuitList.t()} | :error
  ...
  """
  @spec put_encryptors_using_put(String.t(), FwdClient.EncryptorList.t(), keyword) :: :ok | :error
  ...
  """
  @spec put_l2_vpn_using_put(String.t(), String.t(), FwdClient.L2Vpn.t(), keyword) :: :ok | :error
  ...
  """
  @spec put_l2_vpns_using_put(String.t(), FwdClient.L2VpnList.t(), keyword) :: :ok | :error
  ...
  """
  @spec put_l3_vpn_using_put(String.t(), String.t(), FwdClient.L3Vpn.t(), keyword) :: :ok | :error
  ...
  """
  @spec put_l3_vpns_using_put(String.t(), FwdClient.L3VpnList.t(), keyword) :: :ok | :error
