defmodule FwdClient.NetworkLocations do
  ...
  """
  @spec delete_location_using_delete(String.t(), String.t(), keyword) :: :ok | :error
  ...
  """
  @spec get_atlas_using_get(String.t(), keyword) :: {:ok, map} | :error
  ...
  @spec get_device_cluster_using_get(String.t(), String.t(), String.t(), keyword) ::
          {:ok, FwdClient.DeviceCluster.t()} | :error
  ...
  """
  @spec get_locations_using_get(String.t(), keyword) :: {:ok, [FwdClient.Location.t()]} | :error
  ...
  @spec put_locations_using_put(String.t(), FwdClient.Location.t(), keyword) ::
          :ok | {:error, FwdClient.ErrorInfo.t()}
  ...
  """
  @spec update_atlas_using_patch(String.t(), map, keyword) :: :ok | :error
